...
public class Label02Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_label02);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.home_btn:
                Intent intent10=new Intent(Label02Activity.this,chinese.class);
