...
public class Dglabel01Activity extends AppCompatActivity implements View.OnClickListener{
    private Button bluehome_btn,home_btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        supportRequestWindowFeature(Window.FEATURE_NO_TITLE);//去標題
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dglabel01);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.home_btn:
                Intent intent10=new Intent(Dglabel01Activity.this,chinese.class);
