...
public class IBC_P extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ibc__p);

        Bundle bundle =this.getIntent().getExtras();
        String ibcp = bundle.getString("ibcp");



        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(this);
        databaseAccess.open();
        key =  databaseAccess.getibcp(ibcp,"key");
        value =  databaseAccess.getibcp(ibcp,"value");
        ...
        if (ibcp.equals("See4.1.9"))
        {
            Intent intent = new Intent();
            intent.setClass(IBC_P.this,see419.class);
