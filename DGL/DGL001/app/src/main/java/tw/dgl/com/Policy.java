...
public class Policy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter=new MyAdapter(Policy.this);
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            result.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(Policy.this, Policydata.class);
                    Bundle bundle = new Bundle();
                    bundle.putString("policyid", item.getKey());
        ...
        public void filter(String charText) {
            ...
            if (charText.length() != 0 ) {
                mData.addAll(databaseAccess.Search2(charText).entrySet());
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.seaech2, menu);
