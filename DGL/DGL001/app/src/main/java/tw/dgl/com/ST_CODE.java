...
public class ST_CODE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_st__code);

        Bundle bundle = this.getIntent().getExtras();
        String stc = bundle.getString("stc");


        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(this);
        databaseAccess.open();
        key = databaseAccess.getstc(stc, "key");
        value = databaseAccess.getstc(stc, "value");
