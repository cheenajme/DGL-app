...
public class ScaleImage extends ImageView {
    ...
    public void build_image()
    {
        ...
        //將圖片放置畫面中央
        mCenterX = (float)((mDisplayMetrics.widthPixels/8)-(mBitmap.getWidth()/8));
        mCenterY = (float)((mDisplayMetrics.heightPixels/12)-(mBitmap.getHeight()/8));
        mMatrix.postTranslate(mCenterX,mCenterY);
